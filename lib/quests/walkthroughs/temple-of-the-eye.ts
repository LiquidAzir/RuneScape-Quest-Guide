  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to the 3 apprentices, Felix, Tamara, and Cordelia, at the Wizards? Tower." },
    ...
    },
    {
      ...
      steps: [
        { text: "Talk to each apprentice and Wizard Persten at the Temple of the Eye to begin the tutorial." },
