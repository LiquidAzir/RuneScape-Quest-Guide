  ...
  sections: [
    {
      ...
      steps: [
        ...
        { text: "Return to King Narnode for orders." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to Zooknock and use the dentures, mould, and a gold bar on him." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Return to Zooknock with the talisman + monkey bones." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to Garkor, the Elder Guard, Kruk, then King Awowogei to receive the 10th Squad Sigil." },
