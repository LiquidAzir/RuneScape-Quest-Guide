  ...
  sections: [
    {
      ...
      steps: [
        ...
        { text: "Return to Brimstail. He sends you to Hazelmere." },
      ],
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to him — watch the cutscenes about King Healthorg and the white spirit tree." },
        { text: "He gives you a violet pentagon." },
        { text: "Return to Brimstail and report what you saw." },
