  ...
  sections: [
    {
      ...
      steps: [
        ...
        { text: "Talk to Eadgar in his cave at the top of Trollheim about finding goutweed." },
        { text: "Talk to Burntmeat in the Troll Stronghold kitchen." },
        { text: "Return to Eadgar in his cave at the top of Trollheim." },
      ],
    },
    {
      title: "The parrot",
      steps: [
        ...
        { text: "Talk to Parroty Pete at Ardougne Zoo (ask both questions)." },
