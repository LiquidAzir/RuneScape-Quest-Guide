  ...
  sections: [
    {
      ...
      steps: [
        ...
        { text: "Talk to the Watchtower Wizard on the top floor of the Yanille Watchtower again (1•1)." },
      ],
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to Toban on the island west of Gu'Tanoth with dragon bones — get Relic part 3." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to the scared skavid inside the Skavid caves north of Gu'Tanoth for hints." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to the Watchtower Wizard on the top floor of the Yanille Watchtower with the completed potion." },
      ],
    },
    {
      ...
      steps: [
        ...
        { text: "Return to the Watchtower Wizard on the top floor of the Yanille Watchtower with all 4 crystals." },
        {
