  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to Fairy Nuff and Fairy Very Wise." },
        { text: "Return to Zanaris (BKS); pickpocket the Fairy Godfather for Queen's secateurs." },
        { text: "Return to the hideout with the secateurs." },
