  ...
  sections: [
    {
      ...
      steps: [
        ...
        { text: "Talk to Ghaslor the Elder in Nardah and accept the ballad." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Talk to the spirit in the Elid cave and confirm." },
        { text: "Return to Nardah town centre near the mayor?s house." },
      ],
    },
    {
      title: "Genie quest",
      steps: [
        ...
        { text: "Talk to the Genie at the Nardah shrine." },
        { text: "Talk to the Genie at the Nardah shrine again to get the statuette." },
